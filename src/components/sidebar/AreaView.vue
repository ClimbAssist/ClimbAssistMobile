<template>
  <v-list two-line>
    <div v-for="(subArea, subkey) in area.filteredSubAreas" :key="subkey">
      <v-list-item input-value="true" color="primary">
        <v-list-item-content>
      ...
      <div v-for="(crag, ckey) in subArea.filteredCrags" :key="ckey">
        <v-list-item :to="'/crags/' + crag.cragId">
          <v-list-item-content>
