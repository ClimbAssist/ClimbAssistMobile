  ...
  methods: {
    fetchData() {
      //get country data
        let countries = []
        //fetch data
        cordova.plugin.http.get("https://www.climbassist.com/v1/countries/", {}, {}, 
        (response) => { 
          //success
          ...
          for (let i in countriesList) {
            ...
            cordova.plugin.http.get("https://www.climbassist.com/v1/countries/" + countriesList[i].countryId + "?depth=6", {}, {}, 
            (response) => {
              //success
          ...
          for (let ri in countries[ci].regions) {
            ...
            for (let ai in countries[ci].regions[ri].areas) {
              ...
              for (let si in countries[ci].regions[ri].areas[ai].subAreas) {
                ...
                for (let cri in countries[ci].regions[ri].areas[ai].subAreas[si].crags) {
                  if (!countries[ci].regions[ri].areas[ai].subAreas[si].crags[cri].walls) {
                    countries[ci].regions[ri].areas[ai].subAreas[si].crags[cri].walls = [];
                  }
                  for (let wi in countries[ci].regions[ri].areas[ai].subAreas[si].crags[cri].walls) {
                    if (!countries[ci].regions[ri].areas[ai].subAreas[si].crags[cri].walls[wi].routes) {
                      countries[ci].regions[ri].areas[ai].subAreas[si].crags[cri].walls[wi].routes = [];
                    }
                  }
                }
                // set subArea locations and Fills
                if (
                  countries[ci].regions[ri].areas[ai].subAreas[si].crags.length > 1
                ) {
                  let minLatitude =
                  ...
                  let maxLongitude =
                    countries[ci].regions[ri].areas[ai].subAreas[si].crags[0]
                      .location.longitude;
                  for (let ckey in countries[ci].regions[ri].areas[ai].subAreas[si]
                    .crags) {
                    if (
                  ...
                  countries[ci].regions[ri].areas[ai].subAreas[si].crags.length > 0
                ) {
                  countries[ci].regions[ri].areas[ai].subAreas[si].location =
                    countries[ci].regions[ri].areas[ai].subAreas[
                      si
                  ...
                  if (fill.maxLongitude) {
                    if (countries[ci].regions[ri].areas[ai].subAreas[
                      si
                    ].crags[0].location.latitude < fill.minLatitude) {
                      fill.minLatitude = countries[ci].regions[ri].areas[ai].subAreas[
                        si
                      ].crags[0].location.latitude;
                    }
                    if (countries[ci].regions[ri].areas[ai].subAreas[
                      si
                    ].crags[0].location.latitude > fill.maxLatitude) {
                      fill.maxLatitude = countries[ci].regions[ri].areas[ai].subAreas[
                        si
                      ].crags[0].location.latitude;
                    }
                    if (countries[ci].regions[ri].areas[ai].subAreas[
                      si
                    ].crags[0].location.longitude < fill.minLongitude) {
                      fill.minLongitude = countries[ci].regions[ri].areas[ai].subAreas[
                        si
                      ].crags[0].location.longitude;
                    }
                    if (countries[ci].regions[ri].areas[ai].subAreas[
                      si
                    ].crags[0].location.longitude > fill.maxLongitude) {
                      fill.maxLongitude = countries[ci].regions[ri].areas[ai].subAreas[
                        si
                      ].crags[0].location.longitude;
                    }
                  } else {
